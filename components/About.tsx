    ...
    <Section id="about" title="About Me">
      ...
      >
        <motion.div className="w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-purple-500 neon-glow-purple flex-shrink-0" variants={itemVariants}>
          <img src="https://scontent.fblr23-1.fna.fbcdn.net/v/t39.30808-1/580807992_1551783059588680_8479079005409076210_n.jpg?stp=c0.160.864.864a_dst-jpg_s200x200_tt6&_nc_cat=101&ccb=1-7&_nc_sid=e99d92&_nc_ohc=6o9Jon24T4wQ7kNvwEIMjzn&_nc_oc=Adl0gq1D8Ssy37wPbF49aeH7riaZ4inySDBHKC6Q_APZBC4klf8LDVuUC4dHUNRyMqU&_nc_zt=24&_nc_ht=scontent.fblr23-1.fna&_nc_gid=U_eXUc49yvAfG6IRfmt7Nw&oh=00_Afjw8UaUC8EgrKD1d5g4_yLoTZ98B6WEUOvXizK55IlGOA&oe=69195467" alt="Vinay Kumar Chelimi" className="w-full h-full object-cover" />
        </motion.div>
